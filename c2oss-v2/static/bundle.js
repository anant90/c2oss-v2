...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoginPage = __webpack_require__(208);
	  ...
	  _createClass(Home, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        window.isLoggedIn ? _react2.default.createElement(_Dashboard2.default, null) : _react2.default.createElement(_LoginPage2.default, null)
	      );
	    }
	  }]);
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'p',
	              null,
	              'This little tool helps you to contribute more to open source projects you like by helping you find open issues to work on.'
	            ),
	            _react2.default.createElement(
	              'p',
	              null,
	              'It aggregates open issues marked as bugs or enhancements in the public Github repositories you have starred or are a member of.'
	            )
	          ),
	          _react2.default.createElement(
	            'a',
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement('span', { className: 'github-logo' }),
	              _react2.default.createElement(
	                'span',
	                { className: 'cta' },
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'reassurance-wrapper' },
	            _react2.default.createElement(
	              'div',
	              { className: 'reassurance' },
	              'We ask access only to your public data'
	            )
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HeroUnit = __webpack_require__(211);

	var _HeroUnit2 = _interopRequireDefault(_HeroUnit);

	var _IssuesUnit = __webpack_require__(212);

	var _IssuesUnit2 = _interopRequireDefault(_IssuesUnit);
	...
	var Dashboard = (function (_React$Component) {
		...
		function Dashboard() {
			...
			_this.getIssues = _this.getIssues.bind(_this);
			_this.onSyncButtonClick = _this.onSyncButtonClick.bind(_this);
		...
		_createClass(Dashboard, [{
			...
			value: function getUser() {
				...
				fetch('/api/user/', { credentials: 'same-origin' }).then(function (response) {
					return response.json();
				}).then(function (json) {
					_this2.setState({ user: json });
				}).catch(function (ex) {
			...
			key: 'getIssues',
			value: function getIssues(activeFilters) {
				var _this3 = this;

				this.setState({ isFetchingIssues: true });

				var options = { filters: activeFilters };
				var params = Object.keys(options).map(function (key) {
					return encodeURIComponent(key) + "=" + encodeURIComponent(options[key]);
				}).join("&").replace(/%20/g, "+");
				var url = '/api/issues' + "?" + params;

				fetch(url, { credentials: 'same-origin' }).then(function (response) {
					return response.json();
				}).then(function (json) {
					_this3.setState({ issues: json, isFetchingIssues: false });
					_this3.getUser();
				}).catch(function (ex) {
					console.log("Exception in getIssues: ", ex);
					_this3.setState({ isFetchingIssues: false });
				});
			}
		}, {
			key: 'onSyncButtonClick',
			value: function onSyncButtonClick() {
				var _this4 = this;

				this.setState({ isSyncing: true });
				fetch('/api/refresh/', { credentials: 'same-origin' }).then(function (response) {}).catch(function (ex) {
					console.log("Exception in getUser: ", ex);
					_this4.setState({ isSyncing: false });
				});
				setTimeout(function () {
					_this4.setState({ isSyncing: false });
					_this4.getIssues(_this4.state.activeFilters);
				}, 5 * 60 * 1000);
			}
		}, {
			key: 'onFilterClick',
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_HeroUnit2.default, this.state.user),
					_react2.default.createElement(_IssuesUnit2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HeroUnit = (function (_React$Component) {
	  _inherits(HeroUnit, _React$Component);

	  function HeroUnit() {
	    _classCallCheck(this, HeroUnit);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(HeroUnit).apply(this, arguments));
	  }

	  _createClass(HeroUnit, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'user-info' },
	            _react2.default.createElement('img', { className: 'avatar-image', src: this.props.avatar_url }),
	            _react2.default.createElement(
	              'div',
	              { className: 'shifted-right' },
	              _react2.default.createElement(
	                'span',
	                { className: 'name' },
	                this.props.name
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'td',
	                  null,
	                  this.props.starred_repos_count
	                ),
	                _react2.default.createElement(
	                  'td',
	                  null,
	                  'Starred Public Repositories'
	                )
	              ),
	              _react2.default.createElement(
	                'tr',
	              ...
	              _react2.default.createElement('tr', { className: 'blank-row' }),
	              _react2.default.createElement(
	                'tr',
	                null,
	                _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'td',
	                  null,
	                  this.props.unassigned_issues_count
	                ),
	                _react2.default.createElement(
	                  'td',
	                  null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactTimeago = __webpack_require__(213);

	var _reactTimeago2 = _interopRequireDefault(_reactTimeago);

	var _Issue = __webpack_require__(214);
	...
	var IssuesUnit = (function (_React$Component) {
	  _inherits(IssuesUnit, _React$Component);

	  function IssuesUnit() {
	    _classCallCheck(this, IssuesUnit);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(IssuesUnit).call(this));

	    _this.onFilterClick = _this.onFilterClick.bind(_this);
	    return _this;
	  }

	  _createClass(IssuesUnit, [{
	    key: 'onFilterClick',
	    value: function onFilterClick(ev) {
	    ...
	    value: function render() {
	      ...
	      var filterNodes = this.props.filters.map(function (filter, index) {
	        var isFilterActive = _this2.props.activeFilters.indexOf(filter) > -1;
	        return _react2.default.createElement(
	          'span',
	          {
	            className: isFilterActive ? "filter active" : "filter",
	            onClick: _this2.onFilterClick,
	            'data-filter': filter,
	            key: index },
	          filter
	        );
	      });
	      var issueNodes = this.props.issues["issues"].map(function (issue, index) {
	        return _react2.default.createElement(_Issue2.default, _extends({ key: index, index: index + 1 }, issue));
	      });
	      return _react2.default.createElement(
	        'div',
	        { className: 'issues-unit' },
	        _react2.default.createElement(
	          'div',
	          { className: 'filters' },
	          filterNodes
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'sync-button-container' },
	          _react2.default.createElement(
	            'button',
	            { className: this.props.shouldShowSyncButton ? "sync-button" : "sync-button disabled",
	              onClick: this.props.shouldShowSyncButton ? this.props.onSyncButtonClick : null },
	            this.props.isSyncing ? _react2.default.createElement(_Loader2.default, { color: 'white' }) : "Sync with Github"
	          ),
	          this.props.isSyncing ? _react2.default.createElement(
	            'div',
	            { className: 'last-synced' },
	            'We will refresh the page after 5 minutes'
	          ) : null,
	          !this.props.isSyncing && this.props.issues["last_synced"] ? _react2.default.createElement(
	            'div',
	            { className: 'last-synced' },
	            'Last synced ',
	            _react2.default.createElement(_reactTimeago2.default, { date: this.props.issues["last_synced"] })
	          ) : null
	        ),
	        this.props.isFetchingIssues ? _react2.default.createElement(
	          'div',
	          { className: 'loader-with-message' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Assignee = (function (_React$Component) {
	  _inherits(Assignee, _React$Component);

	  function Assignee() {
	    _classCallCheck(this, Assignee);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Assignee).apply(this, arguments));
	  }

	  _createClass(Assignee, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	...
	var Issue = (function (_React$Component2) {
	  _inherits(Issue, _React$Component2);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'a',
	            { target: '_blank', href: this.props.html_url },
	            _react2.default.createElement(
	              'div',
	              { className: 'title' },
	              this.props.title
	          ...
	          _react2.default.createElement(
	            ...
	            this.props.number,
	            ' opened ',
	            _react2.default.createElement(_reactTimeago2.default, { date: this.props.github_created_at }),
	            ' by ',
	            _react2.default.createElement(
	              'a',
	              { href: this.props.owner.html_url, target: '_blank' },
	              this.props.owner.login
	            ),
	            this.props.assignee.login ? _react2.default.createElement(Assignee, { url: this.props.assignee.html_url, login: this.props.assignee.login }) : ""
	          )
	        ),
	        _react2.default.createElement(
	          'div',
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement("circle", { className: "path", cx: "50", cy: "50", r: "20", fill: "none", strokeWidth: "3", stroke: this.props.color ? this.props.color : "#4A90E2" })
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "button, input[type=\"button\"], input[type=\"reset\"], input[type=\"submit\"] {\n  appearance: none;\n  background-color: #4A90E2;\n  border: 0;\n  border-radius: 3px;\n  color: #fff;\n  cursor: pointer;\n  display: inline-block;\n  font-family: \"Merriweather-Regular\", \"Helvetica Neue\", \"Helvetica\", \"Roboto\", \"Arial\", sans-serif;\n  font-size: 1em;\n  -webkit-font-smoothing: antialiased;\n  font-weight: 600;\n  line-height: 1;\n  padding: 0.575em 1.15em;\n  text-decoration: none;\n  transition: background-color 150ms ease;\n  user-select: none;\n  vertical-align: middle;\n  white-space: nowrap; }\n  button:hover, button:focus, input[type=\"button\"]:hover, input[type=\"button\"]:focus, input[type=\"reset\"]:hover, input[type=\"reset\"]:focus, input[type=\"submit\"]:hover, input[type=\"submit\"]:focus {\n    background-color: #3b73b5;\n    color: #fff; }\n  button:disabled, input[type=\"button\"]:disabled, input[type=\"reset\"]:disabled, input[type=\"submit\"]:disabled {\n    cursor: not-allowed;\n    opacity: 0.5; }\n    button:disabled:hover, input[type=\"button\"]:disabled:hover, input[type=\"reset\"]:disabled:hover, input[type=\"submit\"]:disabled:hover {\n      background-color: #4A90E2; }\n\nfieldset {\n  background-color: #d2d2d2;\n  border: 1px solid #4A4A4A;\n  margin: 0 0 0.575em;\n  padding: 1.15em; }\n\ninput,\nlabel,\nselect {\n  display: inline-block;\n  font-family: \"Merriweather-Regular\", \"Helvetica Neue\", \"Helvetica\", \"Roboto\", \"Arial\", sans-serif;\n  font-size: 1em; }\n\nlabel {\n  font-weight: 600;\n  margin-bottom: 0.2875em; }\n  label.required::after {\n    content: \"*\"; }\n  label abbr {\n    display: none; }\n\ninput[type=\"color\"], input[type=\"date\"], input[type=\"datetime\"], input[type=\"datetime-local\"], input[type=\"email\"], input[type=\"month\"], input[type=\"number\"], input[type=\"password\"], input[type=\"search\"], input[type=\"tel\"], input[type=\"text\"], input[type=\"time\"], input[type=\"url\"], input[type=\"week\"], input:not([type]), textarea,\nselect[multiple=multiple] {\n  background-color: transparent;\n  border: none;\n  box-sizing: border-box;\n  font-family: \"Merriweather-Regular\", \"Helvetica Neue\", \"Helvetica\", \"Roboto\", \"Arial\", sans-serif;\n  font-size: 1em;\n  transition: all 150ms ease;\n  background: linear-gradient(#4A4A4A, #4A4A4A) no-repeat;\n  background-size: 100% 1px;\n  background-position: 0 1.15em;\n  text-shadow: 0.05em 0 #F4F4F4, -0.05em 0 #F4F4F4; }\n  input[type=\"color\"]:focus, input[type=\"date\"]:focus, input[type=\"datetime\"]:focus, input[type=\"datetime-local\"]:focus, input[type=\"email\"]:focus, input[type=\"month\"]:focus, input[type=\"number\"]:focus, input[type=\"password\"]:focus, input[type=\"search\"]:focus, input[type=\"tel\"]:focus, input[type=\"text\"]:focus, input[type=\"time\"]:focus, input[type=\"url\"]:focus, input[type=\"week\"]:focus, input:not([type]):focus, textarea:focus,\n  select[multiple=multiple]:focus {\n    background: linear-gradient(#4A90E2, #4A90E2) no-repeat;\n    background-size: 100% 1px;\n    background-position: 0 1.15em; }\n  input[type=\"color\"]:hover, input[type=\"date\"]:hover, input[type=\"datetime\"]:hover, input[type=\"datetime-local\"]:hover, input[type=\"email\"]:hover, input[type=\"month\"]:hover, input[type=\"number\"]:hover, input[type=\"password\"]:hover, input[type=\"search\"]:hover, input[type=\"tel\"]:hover, input[type=\"text\"]:hover, input[type=\"time\"]:hover, input[type=\"url\"]:hover, input[type=\"week\"]:hover, input:not([type]):hover, textarea:hover,\n  select[multiple=multiple]:hover {\n    border-color: #3b3b3b; }\n  input[type=\"color\"]:focus, input[type=\"date\"]:focus, input[type=\"datetime\"]:focus, input[type=\"datetime-local\"]:focus, input[type=\"email\"]:focus, input[type=\"month\"]:focus, input[type=\"number\"]:focus, input[type=\"password\"]:focus, input[type=\"search\"]:focus, input[type=\"tel\"]:focus, input[type=\"text\"]:focus, input[type=\"time\"]:focus, input[type=\"url\"]:focus, input[type=\"week\"]:focus, input:not([type]):focus, textarea:focus,\n  select[multiple=multiple]:focus {\n    border-color: #4A90E2;\n    outline: none; }\n  input[type=\"color\"]:disabled, input[type=\"date\"]:disabled, input[type=\"datetime\"]:disabled, input[type=\"datetime-local\"]:disabled, input[type=\"email\"]:disabled, input[type=\"month\"]:disabled, input[type=\"number\"]:disabled, input[type=\"password\"]:disabled, input[type=\"search\"]:disabled, input[type=\"tel\"]:disabled, input[type=\"text\"]:disabled, input[type=\"time\"]:disabled, input[type=\"url\"]:disabled, input[type=\"week\"]:disabled, input:not([type]):disabled, textarea:disabled,\n  select[multiple=multiple]:disabled {\n    background-color: #f2f2f2;\n    cursor: not-allowed; }\n    input[type=\"color\"]:disabled:hover, input[type=\"date\"]:disabled:hover, input[type=\"datetime\"]:disabled:hover, input[type=\"datetime-local\"]:disabled:hover, input[type=\"email\"]:disabled:hover, input[type=\"month\"]:disabled:hover, input[type=\"number\"]:disabled:hover, input[type=\"password\"]:disabled:hover, input[type=\"search\"]:disabled:hover, input[type=\"tel\"]:disabled:hover, input[type=\"text\"]:disabled:hover, input[type=\"time\"]:disabled:hover, input[type=\"url\"]:disabled:hover, input[type=\"week\"]:disabled:hover, input:not([type]):disabled:hover, textarea:disabled:hover,\n    select[multiple=multiple]:disabled:hover {\n      border: 1px solid #4A4A4A; }\n\ntextarea {\n  resize: vertical; }\n\ninput[type=\"search\"] {\n  appearance: none; }\n\ninput[type=\"checkbox\"],\ninput[type=\"radio\"] {\n  display: inline;\n  margin-right: 0.2875em; }\n  input[type=\"checkbox\"] + label,\n  input[type=\"radio\"] + label {\n    display: inline-block; }\n\ninput[type=\"file\"] {\n  margin-bottom: 0.575em;\n  width: 100%; }\n\nselect {\n  margin-bottom: 1.15em;\n  max-width: 100%;\n  width: auto; }\n\nul,\nol {\n  list-style-type: none;\n  margin: 0;\n  padding: 0; }\n\ndl {\n  margin-bottom: 0.575em; }\n  dl dt {\n    font-weight: bold;\n    margin-top: 0.575em; }\n  dl dd {\n    margin: 0; }\n\ntable {\n  border-collapse: collapse;\n  font-feature-settings: \"kern\", \"liga\", \"tnum\";\n  table-layout: fixed;\n  width: 100%; }\n\nth {\n  border-bottom: 1px solid #383838;\n  font-weight: 600;\n  padding: 0.575em 0;\n  text-align: left; }\n\ntd {\n  padding: 0.575em 0; }\n\ntr,\ntd,\nth {\n  vertical-align: middle; }\n\nbody {\n  color: #4A4A4A;\n  font-family: \"Merriweather-Regular\", \"Helvetica Neue\", \"Helvetica\", \"Roboto\", \"Arial\", sans-serif;\n  font-feature-settings: \"kern\", \"liga\", \"pnum\";\n  font-size: 1em;\n  line-height: 1.15; }\n\nh1,\nh2,\nh3,\nh4,\nh5,\nh6 {\n  font-family: \"Lato-Light\", \"Helvetica Neue\", \"Helvetica\", \"Roboto\", \"Arial\", sans-serif;\n  font-size: 1em;\n  line-height: 1.15;\n  margin: 0 0 0.575em; }\n\np {\n  margin: 0 0 0.575em; }\n\na {\n  color: #4A90E2;\n  text-decoration: none;\n  transition: color 150ms ease; }\n  a:active, a:focus, a:hover {\n    color: #386caa; }\n\nhr {\n  border-bottom: 1px solid #4A4A4A;\n  border-left: 0;\n  border-right: 0;\n  border-top: 0;\n  margin: 1.15em 0; }\n\nimg,\npicture {\n  margin: 0;\n  max-width: 100%; }\n\n@font-face {\n  font-family: \"icons-font\";\n  src: url(data:application/x-font-woff;charset=utf-8;base64,);\n  font-weight: normal;\n  font-style: normal; }\n\n@font-face {\n  font-family: \"Lato-Regular\";\n  src: url(" + __webpack_require__(219) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: \"Lato-Light\";\n  src: url(" + __webpack_require__(220) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: \"Lato-Bold\";\n  src: url(" + __webpack_require__(221) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: \"Merriweather-Regular\";\n  src: url(" + __webpack_require__(222) + ") format(\"truetype\"); }\n\nbody {\n  margin: 0; }\n\nhtml {\n  box-sizing: border-box; }\n\n*, *::after, *::before {\n  box-sizing: inherit; }\n\n.home-link {\n  font-family: \"Lato-Regular\", \"Helvetica Neue\", \"Helvetica\", \"Roboto\", \"Arial\", sans-serif; }\n  @media screen and (max-width: 480px) {\n    .home-link {\n      max-width: 90%;\n      margin: 0 auto;\n      display: block; } }\n\n.hero-unit {\n  max-width: 68em;\n  margin-left: auto;\n  margin-right: auto;\n  margin-top: 8em; }\n  .hero-unit::after {\n    clear: both;\n    content: \"\";\n    display: table; }\n  @media screen and (max-width: 768px) {\n    .hero-unit {\n      margin-top: 2em;\n      margin-bottom: 2em; } }\n  .hero-unit:before {\n    background-image: url(" + __webpack_require__(223) + ");\n    position: absolute;\n    content: '';\n    left: 0;\n    right: 0;\n    top: 0;\n    height: 20em;\n    width: 100%;\n    z-index: -1; }\n    @media screen and (max-width: 768px) {\n      .hero-unit:before {\n        height: 20em; } }\n  .hero-unit .user-box {\n    color: white;\n    float: left;\n    display: block;\n    margin-right: 2.35765%;\n    width: 23.23176%; }\n    .hero-unit .user-box:last-child {\n      margin-right: 0; }\n    @media screen and (max-width: 768px) {\n      .hero-unit .user-box {\n        width: 100%;\n        margin: 0 auto; } }\n  @media screen and (max-width: 1088px) {\n    .hero-unit .home-link {\n      display: none; } }\n  .hero-unit .user-info {\n    padding: 3em 0; }\n    @media screen and (max-width: 1088px) {\n      .hero-unit .user-info {\n        padding-left: 1em; } }\n    @media screen and (max-width: 768px) {\n      .hero-unit .user-info {\n        padding: 0 0 1em;\n        margin-left: 50%;\n        transform: translateX(-50%); } }\n    .hero-unit .user-info .avatar-image {\n      width: 75px;\n      height: 75px;\n      border-radius: 100%;\n      position: absolute; }\n    .hero-unit .user-info .shifted-right {\n      padding-left: 100px; }\n    .hero-unit .user-info .name {\n      padding-bottom: 2px;\n      padding-top: 16px;\n      font-family: \"Lato-Bold\", \"Helvetica Neue\", \"Helvetica\", \"Roboto\", \"Arial\", sans-serif;\n      font-size: 1.5em;\n      display: block; }\n    .hero-unit .user-info .username {\n      padding-top: 2px;\n      padding-bottom: 16px;\n      font-family: \"Lato-Bold\", \"Helvetica Neue\", \"Helvetica\", \"Roboto\", \"Arial\", sans-serif;\n      font-size: 0.9em;\n      display: block; }\n  .hero-unit .user-stats {\n    margin-left: 51.17883%;\n    float: left;\n    display: block;\n    margin-right: 2.35765%;\n    width: 23.23176%;\n    margin-right: 0; }\n    .hero-unit .user-stats:last-child {\n      margin-right: 0; }\n    @media screen and (max-width: 768px) {\n      .hero-unit .user-stats {\n        width: auto;\n        margin: 0 auto; } }\n    .hero-unit .user-stats table {\n      color: white;\n      table-layout: fixed;\n      font-family: \"Lato-Bold\", \"Helvetica Neue\", \"Helvetica\", \"Roboto\", \"Arial\", sans-serif;\n      font-size: 0.7em; }\n      .hero-unit .user-stats table tr.blank-row {\n        height: 1.5em; }\n      .hero-unit .user-stats table td:first-child {\n        width: 40%;\n        color: #4A90E2;\n        text-align: right;\n        padding-right: 1.25em; }\n\n.issues-unit {\n  max-width: 68em;\n  margin-left: auto;\n  margin-right: auto;\n  font-family: \"Lato-Regular\", \"Helvetica Neue\", \"Helvetica\", \"Roboto\", \"Arial\", sans-serif; }\n  .issues-unit::after {\n    clear: both;\n    content: \"\";\n    display: table; }\n  .issues-unit .filters {\n    float: left;\n    display: block;\n    margin-right: 2.35765%;\n    width: 74.41059%;\n    padding: 2em 1em; }\n    .issues-unit .filters:last-child {\n      margin-right: 0; }\n    @media screen and (max-width: 768px) {\n      .issues-unit .filters {\n        float: left;\n        display: block;\n        margin-right: 2.35765%;\n        width: 100%;\n        margin-right: 0; }\n        .issues-unit .filters:last-child {\n          margin-right: 0; } }\n    .issues-unit .filters .filter {\n      display: inline-block;\n      cursor: pointer;\n      padding: 0 10px;\n      font-size: 1.25em;\n      color: #9B9B9B; }\n      .issues-unit .filters .filter.active {\n        font-family: \"Lato-Bold\", \"Helvetica Neue\", \"Helvetica\", \"Roboto\", \"Arial\", sans-serif;\n        color: #4A90E2; }\n      .issues-unit .filters .filter:first-child {\n        padding-left: 0; }\n  .issues-unit .sync-button-container {\n    float: left;\n    display: block;\n    margin-right: 2.35765%;\n    width: 23.23176%;\n    margin-right: 0;\n    text-align: right; }\n    .issues-unit .sync-button-container:last-child {\n      margin-right: 0; }\n    @media screen and (max-width: 768px) {\n      .issues-unit .sync-button-container {\n        display: none; } }\n    .issues-unit .sync-button-container .sync-button {\n      margin: 28px 20px 0 0;\n      font-family: \"Lato-Bold\", \"Helvetica Neue\", \"Helvetica\", \"Roboto\", \"Arial\", sans-serif;\n      text-transform: uppercase;\n      width: 190px;\n      height: 35px; }\n      .issues-unit .sync-button-container .sync-button.disabled {\n        cursor: auto;\n        background-color: lightgray; }\n    .issues-unit .sync-button-container .last-synced {\n      color: #9B9B9B;\n      font-size: 0.75em;\n      font-family: \"Lato-Light\", \"Helvetica Neue\", \"Helvetica\", \"Roboto\", \"Arial\", sans-serif;\n      margin: 5px 20px 0 0; }\n  .issues-unit .loader-with-message {\n    float: left;\n    display: block;\n    margin-right: 2.35765%;\n    width: 100%;\n    text-align: center;\n    font-size: 1.5em; }\n    .issues-unit .loader-with-message:last-child {\n      margin-right: 0; }\n    .issues-unit .loader-with-message .message {\n      padding-top: 50px; }\n    .issues-unit .loader-with-message .loader {\n      transform: translateX(-50%); }\n  .issues-unit .issue {\n    max-width: 68em;\n    margin-left: auto;\n    margin-right: auto;\n    padding: 0 1em; }\n    .issues-unit .issue::after {\n      clear: both;\n      content: \"\";\n      display: table; }\n    .issues-unit .issue:nth-child(even) {\n      background-color: #fafafa; }\n    .issues-unit .issue a {\n      color: #4A4A4A; }\n    .issues-unit .issue .float-left {\n      float: left;\n      display: block;\n      margin-right: 2.35765%;\n      width: 65.88078%;\n      padding: 13px 0; }\n      .issues-unit .issue .float-left:last-child {\n        margin-right: 0; }\n    .issues-unit .issue .float-right {\n      margin-left: 8.5298%;\n      float: left;\n      display: block;\n      margin-right: 2.35765%;\n      width: 23.23176%;\n      margin-right: 0;\n      text-align: right;\n      padding: 13px 0; }\n      .issues-unit .issue .float-right:last-child {\n        margin-right: 0; }\n    .issues-unit .issue .index, .issues-unit .issue .byline, .issues-unit .issue .comments-count {\n      color: #9B9B9B; }\n    .issues-unit .issue .index, .issues-unit .issue .repo {\n      font-size: 1.125em; }\n    .issues-unit .issue .title {\n      font-size: 1.25em; }\n    .issues-unit .issue .title, .issues-unit .issue .repo {\n      padding-bottom: 4px; }\n    .issues-unit .issue .byline, .issues-unit .issue .comments-count {\n      font-size: 0.875em; }\n    .issues-unit .issue .index {\n      position: absolute;\n      margin-left: -4em;\n      margin-top: 0.05em;\n      width: 2.5em;\n      text-align: right; }\n    .issues-unit .issue .repo {\n      white-space: nowrap;\n      overflow: hidden; }\n    .issues-unit .issue .assignee {\n      display: inline-block; }\n\n.loader {\n  position: absolute;\n  display: inline-block;\n  width: 30px; }\n  .loader:before {\n    content: '';\n    display: block;\n    padding-top: 100%; }\n\n.sync-button .loader {\n  transform: translate(-15px, -15px); }\n\n.circular {\n  animation: rotate 2s linear infinite;\n  height: 100%;\n  transform-origin: center center;\n  width: 100%;\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  margin: auto; }\n\n.path {\n  stroke-dasharray: 1,200;\n  stroke-dashoffset: 0;\n  animation: dash 1.5s ease-in-out infinite;\n  stroke-linecap: round; }\n\n@keyframes rotate {\n  100% {\n    transform: rotate(360deg); } }\n\n@keyframes dash {\n  0% {\n    stroke-dasharray: 1,200;\n    stroke-dashoffset: 0; }\n  50% {\n    stroke-dasharray: 89,200;\n    stroke-dashoffset: -35px; }\n  100% {\n    stroke-dasharray: 89,200;\n    stroke-dashoffset: -124px; } }\n\n.landing-page-wrapper {\n  max-width: 68em;\n  margin-left: auto;\n  margin-right: auto;\n  margin-top: 9em; }\n  .landing-page-wrapper::after {\n    clear: both;\n    content: \"\";\n    display: table; }\n  @media screen and (max-width: 768px) {\n    .landing-page-wrapper {\n      margin-top: 4em; } }\n\n.landing-page {\n  margin-left: 8.5298%;\n  @span-columns 10 {} }\n  @media screen and (max-width: 768px) {\n    .landing-page {\n      margin-left: 0; } }\n\n.landing-logo {\n  font-family: \"Lato-Light\", \"Helvetica Neue\", \"Helvetica\", \"Roboto\", \"Arial\", sans-serif;\n  font-size: 3em; }\n  @media screen and (max-width: 768px) {\n    .landing-logo {\n      font-size: 2em; } }\n\n.landing-copy {\n  max-width: 50%;\n  font-size: 1.125em;\n  line-height: 1.5;\n  padding: 1em 0 3em; }\n  @media screen and (max-width: 768px) {\n    .landing-copy {\n      font-size: 1em; } }\n\n.login-button {\n  display: flex;\n  width: 17em;\n  border-radius: 0.75em;\n  margin-bottom: 0.25em;\n  background-color: #4A90E2;\n  padding: 0.5em;\n  cursor: pointer; }\n  .login-button .github-logo {\n    margin: auto;\n    color: white;\n    font-size: 2em; }\n    .login-button .github-logo:before {\n      display: inline-block;\n      font-family: \"icons-font\";\n      font-style: normal;\n      font-weight: normal;\n      font-variant: normal;\n      line-height: 1;\n      text-decoration: inherit;\n      text-rendering: optimizeLegibility;\n      text-transform: none;\n      -moz-osx-font-smoothing: grayscale;\n      -webkit-font-smoothing: antialiased;\n      font-smoothing: antialiased;\n      speak: none;\n      content: \"\\F10E\"; }\n  .login-button .cta {\n    margin: auto;\n    color: white;\n    font-family: \"Lato-Bold\", \"Helvetica Neue\", \"Helvetica\", \"Roboto\", \"Arial\", sans-serif;\n    font-size: 1.125em; }\n\n.reassurance-wrapper {\n  width: 17em;\n  display: flex; }\n\n.reassurance {\n  font-family: \"Lato-Regular\", \"Helvetica Neue\", \"Helvetica\", \"Roboto\", \"Arial\", sans-serif;\n  font-size: 0.875em;\n  margin: auto;\n  color: #9B9B9B; }\n\n@media screen and (max-width: 480px) {\n  .landing-logo, .landing-copy, .login-button, .reassurance-wrapper {\n    max-width: 90%;\n    margin: 1em auto; } }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "static/Lato-Regular-7f690e503a254e0b8349aec0177e07aa.ttf";

/***/ },
/* 220 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "static/Lato-Light-5b761f2d1e4259ea6ac7ab3ebf7f3c49.ttf";

/***/ },
/* 221 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "static/Lato-Bold-44dfe8cc676882243911a3197a50169e.ttf";

/***/ },
/* 222 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "static/Merriweather-Regular-f2e4a31c9defd3f77e1711031ece8cf8.ttf";

/***/ },
/* 223 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "static/header-pattern-9a30e6c6c75344e5bd217bbe9720ef3e.png";
